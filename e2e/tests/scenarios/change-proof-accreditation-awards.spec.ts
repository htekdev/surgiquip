 ...
 *   → Factory certs updated: Skytron, Midmark, Tuttnauer — updated
...
test('change-proof-accreditation-awards', async ({ page }) => {
  ...
  await showPhaseLabel(page, '🔗 Navigating → About → Accreditation');
  await page.waitForTimeout(800);
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // PART 3 — BBB Torch Award section (NEW — 5 consecutive years)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  await showPhaseLabel(page, '📜 Scrolling full credentials + compliance section');
  await page.waitForTimeout(800);
  await smoothScroll(page, 1200, 300, 500);
  await page.waitForTimeout(1200);

  // ═══════════════════════════════════════════════════════════════════════════
  // PART 5 — Compliance section
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // PART 6 — Back to About index via breadcrumb
  // ═══════════════════════════════════════════════════════════════════════════
